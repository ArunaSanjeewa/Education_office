...
angular.module('myApp.planning-dep', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/planning-dep', {
            templateUrl: 'views/planning-dep/planning-dep.html',
            controller: 'planning-depCtrl'
        });
    }])

    .controller('planning-depCtrl',['$http','$scope',function($http, $scope) {
        ...
        var getaccout= function () {
            ...
            $http.get(baseurl+'/getplanning').success(function (datafromRouter) {
