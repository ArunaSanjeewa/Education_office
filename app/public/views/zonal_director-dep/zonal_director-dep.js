...
angular.module('myApp.zonal_director-dep', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/zonal_director-dep', {
            templateUrl: 'views/zonal_director-dep/zonal_director-dep.html',
            controller: 'zonal_director-depCtrl'
        });
    }])

    .controller('zonal_director-depCtrl',['$http','$scope',function($http, $scope) {
        console.log("development-depdevelopment-depCtrl");
        ...
        var getaccout= function () {


            $http.get(baseurl+'/getzonal_director').success(function (datafromRouter) {
