...
angular.module('myApp.add-zonal_director', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/add-zonal_director', {
            templateUrl: 'views/add-zonal_director/add-zonal_director.html',
            controller: 'add-zonal_directorctrl'
        });
    }])
    .controller('add-zonal_directorctrl',function($http, $scope,$location, $window) {
        console.log("aadd-zonal_directoradd-zonal_directort");
        ...
        var getReqNo = function (lastNo) {
            ...
            if (lastNo == "") {
                ...
                $scope.Req_No = 'ZDIRECTOR/' + year + "/" + ans;
            } else {
