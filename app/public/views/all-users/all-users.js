...
angular.module('myApp.all-users', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/all-users', {
            templateUrl: 'views/all-users/all-users.html',
            controller: 'all-usersCtrl'
        });
    }])

    .controller('all-usersCtrl', ['$http','$scope',function($http, $scope) {
        ...
        var getallusers= function () {
            ...
            $http.get(baseurl+'/getallusers').success(function (datafromRouter) {
