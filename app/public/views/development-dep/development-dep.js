...
angular.module('myApp.development-dep', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/development-dep', {
            templateUrl: 'views/development-dep/development-dep.html',
            controller: 'development-depCtrl'
        });
    }])

    .controller('development-depCtrl',['$http','$scope',function($http, $scope) {
        ...
        var getaccout= function () {
            ...
            $http.get(baseurl+'/getdevelp').success(function (datafromRouter) {
