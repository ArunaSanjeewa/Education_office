...
angular.module('myApp.add-planning', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/add-planning', {
            templateUrl: 'views/add-planning/add-planning.html',
            controller: 'add-planningctrl'
        });
    }])
    .controller('add-planningctrl',function($http, $scope,$location, $window) {
        ...
        var getReqNo = function (lastNo) {
            ...
            if (lastNo == "") {
                ...
                $scope.Req_No = 'PLANNING/' + year + "/" + ans;
            } else {
