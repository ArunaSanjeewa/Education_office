...
angular.module('myApp.account-dep', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/account-dep', {
    templateUrl: 'views/account-dep/account-dep.html',
    controller: 'account-depCtrl'
  });
}])

.controller('account-depCtrl',['$http','$scope',function($http, $scope) {
  console.log("account-depCtrl");
  ...
  var getaccout= function () {
    ...
    $http.get(baseurl+'/getaccount').success(function (datafromRouter) {
